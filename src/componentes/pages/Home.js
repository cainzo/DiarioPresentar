  ...
  return (
    <div className="main">
      ...
      <Card className="w-100 bg-dark p-0 m-0 shadow">
        <Card.Img src="https://images.pexels.com/photos/3953481/pexels-photo-3953481.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Card image" className="w-100 img-titulado-home m-0 p-0" />
