    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path="/contactanos" element={<Contactanos></Contactanos>}></Route>
          ...
          <Route path="/perfil">
            <Route
              ...
              element={
                user ? (
                  user.isAdmin ? (
                    <PerfilAdmin categorias={categorias}></PerfilAdmin>
                  ) : (
                    <Navigate to="/" />
                  )
                ) : (
            ...
            <Route path="/perfil/nuevaNoticia">
              <Route
                ...
                element={
                  user ? (
                    user.isAdmin ? (
                      <NuevaNoticia categorias={categorias}></NuevaNoticia>
                    ) : (
                      <Navigate to="/" />
                    )
                  ) : (
            ...
            <Route path="/perfil/editarNoticia/:nId">
              <Route
                ...
                element={
                  user ? (
                    user.isAdmin ? (
                      <EditarNoticia categorias={categorias}> </EditarNoticia>
                    ) : (
                      <Navigate to="/" />
                    )
                  ) : (
